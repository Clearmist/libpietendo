...
struct DeleteSpec
{
    enum Flag
    {
        Flag_DeleteNonSystemTitles =
            0,              // this deletes all titles from NAND without the system app bit, excluding "Self", see below
        Flag_DeleteSelf = 1 // This refers to when the systemupdater was installed to NAND (old install method), the
                            // titleID was 0x000400000fd00200
    };
