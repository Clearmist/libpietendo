...
{
    std::array<byte_t, 0x100> signature; // PKCS1-RSA2048-SHA2-256 over 0x000 - end of hashes (according to 3dbrew a
                                         // fixed size of 0x358 bytes). CRR0 files must be stored under "romfs:/.crr/".
                                         // The end of the file is aligned to a 0x1000-byte boundary with 0xCC bytes.
