...
{
  public:
    TitleMetaData() : signature(), title_id(0), title_version(0), content_info()
    {
    ...
    {
      public:
        ContentInfo() : id(0), index(0), is_encrypted(0), is_optional(0), size(0)
        {
        ...
        ContentInfo(
            ...
            : id(id), index(index), is_encrypted(is_encrypted), is_optional(is_optional), size(size), hash(hash)
        {
        }
