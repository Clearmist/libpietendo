 ...
 * * __PERSONALIZED__ - Same as __COMMON__ but the encrypted payload is further encrypted using RSA2048-OAEP, with the
 * device specific RSA key.
 */
...
struct ESTicket
{
    ...
    ESSysAccessMask sysAccessMask;   /**< 16-bit cidx mask to indicate which of the first 16 pieces of contents can be
                                        accessed by the system app */
