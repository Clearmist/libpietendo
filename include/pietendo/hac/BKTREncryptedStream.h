...
class BKTREncryptedStream : public tc::io::IStream
{
  public:
     ...
     * @post This will create an uninitialized BKTREncryptedStream, it will have to be assigned from a valid
     *BKTREncryptedStream object to be usable.
     **/
    BKTREncryptedStream();
    ...
    BKTREncryptedStream(
        ...
        const std::shared_ptr<tc::io::IStream> &baseStream);
     ...
     *the number of bytes written. @ref write is not supported for @ref BKTREncryptedStream.
