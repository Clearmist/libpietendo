...
class ApplicationControlPropertyUtil
{
  public:
    ...
    static std::string
    getContentsAvailabilityTransitionPolicyAsString(pie::hac::nacp::ContentsAvailabilityTransitionPolicy val);
    ...
    static std::string
    getRequiredNetworkServiceLicenseOnLaunchFlagAsString(pie::hac::nacp::RequiredNetworkServiceLicenseOnLaunchFlag val);
    ...
    static std::string
    getSupportingLimitedApplicationLicensesFlagAsString(pie::hac::nacp::SupportingLimitedApplicationLicensesFlag val);
