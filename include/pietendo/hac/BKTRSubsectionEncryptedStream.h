...
class BKTRSubsectionEncryptedStream : public tc::io::IStream
{
  public:
     ...
     * @post This will create an uninitialized BKTRSubsectionEncryptedStream, it will have to be assigned from a valid
     *BKTRSubsectionEncryptedStream object to be usable.
     **/
     ...
     *the number of bytes written. @ref write is not supported for @ref BKTRSubsectionEncryptedStream.
