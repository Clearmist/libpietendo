...
struct sApplicationControlProperty
{
    ...
    byte_t program_index; // last byte of programId, (programId - programIndex) is used as default values for
                          // PresenceGroupId, SaveDataOwnerId, LocalCommunicationId
    ...
    std::array<tc::bn::le16<sRequiredAddOnContentEntry>, nacp::kRequiredAddOnContentsSetCount>
        required_add_on_contents_set; // this is a collection of arrays of AddOnContent Indexes (valid values: 1-2000).
                                      // Bit 0-14: AddOnContentIndex, Bit 15: If set, this array continues with next
                                      // value, if not set, this array ends with this value
