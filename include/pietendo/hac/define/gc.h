...
static const uint32_t kNormalAreaStartPageAddress = kReservedAreaPageCount + kCertAreaPageCount + kCardHeaderPageCount +
kCardKeyAreaPageCount;
*/
...
struct sGcKeyDataRegion
{
    ...
    union
    {
        ...
        struct
        {
            detail::rsa2048_block_t
                encrypted_data; // RSA2048-OAEP-SHA256 encrypted AES-CTR data used for encrypted_00 {key[16],iv[16]}
        } enc;
        struct
        {
