...
static_assert(
    sizeof(sContentArchiveFsHeaderSparseInfo) == nca::kSparseInfoLen, "sContentArchiveFsHeaderSparseInfo size.");
...
static_assert(
    sizeof(sContentArchiveFsHeaderCompressionInfo) == nca::kCompressionInfoLen,
    "sContentArchiveFsHeaderCompressionInfo size.");
...
static_assert(
    sizeof(sContentArchiveFsHeaderMetaDataHashDataInfo) == nca::kMetaDataHashDataInfoLen,
    "sContentArchiveFsHeaderMetaDataHashDataInfo size.");
