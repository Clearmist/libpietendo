...
pie::ctr::es::CertificateDeserialiser::CertificateDeserialiser(const std::shared_ptr<tc::io::IStream> &cert_stream)
    : Certificate(), mModuleLabel("pie::ctr::es::CertificateDeserialiser")
{
    ...
    tc::crypto::GenerateSha2256Hash(
        calculated_hash.data(), total_cert_data.data() + getCertificateSignableOffset(total_cert_data.data()),
        pie::ctr::es::getCertificateSignableSize(total_cert_data.data()));
