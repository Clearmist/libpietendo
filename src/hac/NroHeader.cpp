...
{
    return (mRoCrtEntryPoint == other.mRoCrtEntryPoint) && (mRoCrtModOffset == other.mRoCrtModOffset) &&
           (mNroSize == other.mNroSize) && (mTextInfo == other.mTextInfo) && (mTextInfo == other.mTextInfo) &&
           (mRoInfo == other.mRoInfo) && (mDataInfo == other.mDataInfo) && (mBssSize == other.mBssSize) &&
           (mModuleId == other.mModuleId) && (mRoEmbeddedInfo == other.mRoEmbeddedInfo) &&
           (mRoDynStrInfo == other.mRoDynStrInfo) && (mRoDynSymInfo == other.mRoDynSymInfo);
}
