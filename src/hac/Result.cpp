...
pie::hac::Result::Result() : mResult(0) {}

pie::hac::Result::Result(uint32_t result) : mResult(result) {}

pie::hac::Result::Result(uint32_t module_num, uint32_t desc, uint32_t sub_desc) : mResult(0)
{
