...
{
    return (mModuleId == other.mModuleId) && (mBssSize == other.mBssSize) &&
           (mTextSegmentInfo == other.mTextSegmentInfo) && (mRoSegmentInfo == other.mRoSegmentInfo) &&
           (mDataSegmentInfo == other.mDataSegmentInfo) && (mModuleNameInfo == other.mModuleNameInfo) &&
           (mRoEmbeddedInfo == other.mRoEmbeddedInfo) && (mRoDynStrInfo == other.mRoDynStrInfo) &&
           (mRoDynSymInfo == other.mRoDynSymInfo);
}
