...
{
    return (mIsServer == other.mIsServer) && (mName == other.mName);
}
...
void pie::hac::ServiceAccessControlEntry::toBytes()
{
    ...
    {
        throw tc::OutOfMemoryException(
            kModuleName, "Failed to allocate memory for ServiceAccessControlEntry: " + std::string(e.what()));
    }
