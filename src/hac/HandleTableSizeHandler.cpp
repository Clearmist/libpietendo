...
pie::hac::HandleTableSizeHandler::HandleTableSizeHandler() : mIsSet(false), mEntry(0) {}
...
{
    return (mIsSet == other.mIsSet) && (mEntry.getKernelCapability() == other.mEntry.getKernelCapability());
}
