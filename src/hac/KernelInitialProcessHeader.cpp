...
{
    return (this->mName == other.mName) && (this->mTitleId == other.mTitleId) && (this->mVersion == other.mVersion) &&
           (this->mIs64BitInstructionFlag == other.mIs64BitInstructionFlag) &&
           (this->mIs64BitAddressSpaceFlag == other.mIs64BitAddressSpaceFlag) &&
           (this->mUseSecureMemoryFlag == other.mUseSecureMemoryFlag) &&
           (this->mMainThreadPriority == other.mMainThreadPriority) &&
           (this->mMainThreadCpuId == other.mMainThreadCpuId) &&
           (this->mMainThreadStackSize == other.mMainThreadStackSize) && (this->mTextInfo == other.mTextInfo) &&
           (this->mRoInfo == other.mRoInfo) && (this->mDataInfo == other.mDataInfo) &&
           (this->mBssSize == other.mBssSize) && (this->mKernelCapabilities == other.mKernelCapabilities);
}
...
void pie::hac::KernelInitialProcessHeader::toBytes()
{
    ...
    {
        memset(
            hdr->capabilities.data() + mKernelCapabilities.getBytes().size(), 0xff,
            hdr->capabilities.size() - mKernelCapabilities.getBytes().size());
    }
...
const pie::hac::KernelInitialProcessHeader::sCodeSegment &
pie::hac::KernelInitialProcessHeader::getTextSegmentInfo() const
{
    return mTextInfo;
}
...
const pie::hac::KernelInitialProcessHeader::sCodeSegment &
pie::hac::KernelInitialProcessHeader::getDataSegmentInfo() const
{
    return mDataInfo;
}
