...
{
    return (mThreadInfo == other.mThreadInfo) && (mSystemCalls == other.mSystemCalls) &&
           (mMemoryMap == other.mMemoryMap) && (mInterupts == other.mInterupts) && (mMiscParams == other.mMiscParams) &&
           (mKernelVersion == other.mKernelVersion) && (mHandleTableSize == other.mHandleTableSize) &&
           (mMiscFlags == other.mMiscFlags);
}
