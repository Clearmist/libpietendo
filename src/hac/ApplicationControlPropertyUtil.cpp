...
std::string pie::hac::ApplicationControlPropertyUtil::getAddOnContentRegistrationTypeAsString(
    pie::hac::nacp::AddOnContentRegistrationType val)
{
    std::string str;
...
std::string
pie::hac::ApplicationControlPropertyUtil::getAppropriateAgeForChinaAsString(pie::hac::nacp::AppropriateAgeForChina val)
{
    std::string str;
...
std::string pie::hac::ApplicationControlPropertyUtil::getContentsAvailabilityTransitionPolicyAsString(
    pie::hac::nacp::ContentsAvailabilityTransitionPolicy val)
{
    std::string str;
...
std::string
pie::hac::ApplicationControlPropertyUtil::getCrashScreenshotForDevAsString(pie::hac::nacp::CrashScreenshotForDev val)
{
    std::string str;
...
std::string
pie::hac::ApplicationControlPropertyUtil::getCrashScreenshotForProdAsString(pie::hac::nacp::CrashScreenshotForProd val)
{
    std::string str;
...
std::string
pie::hac::ApplicationControlPropertyUtil::getDataLossConfirmationAsString(pie::hac::nacp::DataLossConfirmation val)
{
    std::string str;
...
std::string
pie::hac::ApplicationControlPropertyUtil::getJitConfigurationFlagAsString(pie::hac::nacp::JitConfigurationFlag val)
{
    std::string str;
...
std::string
pie::hac::ApplicationControlPropertyUtil::getParentalControlFlagAsString(pie::hac::nacp::ParentalControlFlag val)
{
    std::string str;
...
std::string
pie::hac::ApplicationControlPropertyUtil::getPlayLogQueryCapabilityAsString(pie::hac::nacp::PlayLogQueryCapability val)
{
    std::string str;
...
std::string
pie::hac::ApplicationControlPropertyUtil::getPlayReportPermissionAsString(pie::hac::nacp::PlayReportPermission val)
{
    std::string str;
...
std::string pie::hac::ApplicationControlPropertyUtil::getRequiredNetworkServiceLicenseOnLaunchFlagAsString(
    pie::hac::nacp::RequiredNetworkServiceLicenseOnLaunchFlag val)
{
    std::string str;
...
std::string pie::hac::ApplicationControlPropertyUtil::getRuntimeAddOnContentInstallAsString(
    pie::hac::nacp::RuntimeAddOnContentInstall val)
{
    std::string str;
...
std::string pie::hac::ApplicationControlPropertyUtil::getRuntimeParameterDeliveryAsString(
    pie::hac::nacp::RuntimeParameterDelivery val)
{
    std::string str;
...
std::string
pie::hac::ApplicationControlPropertyUtil::getStartupUserAccountAsString(pie::hac::nacp::StartupUserAccount val)
{
    std::string str;
...
std::string pie::hac::ApplicationControlPropertyUtil::getStartupUserAccountOptionFlagAsString(
    pie::hac::nacp::StartupUserAccountOptionFlag val)
{
    std::string str;
...
std::string pie::hac::ApplicationControlPropertyUtil::getSupportingLimitedApplicationLicensesFlagAsString(
    pie::hac::nacp::SupportingLimitedApplicationLicensesFlag val)
{
    std::string str;
...
std::string
pie::hac::ApplicationControlPropertyUtil::getUserAccountSwitchLockAsString(pie::hac::nacp::UserAccountSwitchLock val)
{
    std::string str;
