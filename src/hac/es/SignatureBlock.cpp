...
{
    return (mSignType == other.mSignType) && (mIsLittleEndian == other.mIsLittleEndian) &&
...
void pie::hac::es::SignatureBlock::toBytes()
{
    ...
    {
        throw tc::ArgumentException(kModuleName, "Signature size is incorrect");
    }
...
void pie::hac::es::SignatureBlock::fromBytes(const byte_t *src, size_t size)
{
    ...
    if (size < sizeof(sEcdsa240SignBlock))
    {
